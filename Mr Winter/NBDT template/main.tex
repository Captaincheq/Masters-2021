...
\begin{figure}[bt]
\centering
%\includegraphics[width=6cm, height=6cm,natwidth=600,natheight=600]{example-image-rectangle.png}
\includegraphics[width=6cm, height=6cm]{example-image-rectangle.png}
